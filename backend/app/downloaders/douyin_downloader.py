...
class DouyinDownloader(Downloader):
    ...
    def download(
        ...
        try:
            print(f"正在下载视频: {video_url}，保存路径: {output_dir}，质量: {quality}")
            ...
            return AudioDownloadResult(
                ...
                cover_url=video_data["aweme_detail"]["video"]["cover_original_scale"][
                    "url_list"
                ][0]
                if video_data["aweme_detail"]["video"]["cover"]
    ...
    def download_video(
        self, video_url: str, output_dir: Union[str, None] = None
    ) -> str:
