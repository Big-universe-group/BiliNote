...
# 清理旧的构建
echo "清理旧的构建..."
rm -rf backend/dist backend/build ./frontend/src-tauri/bin/*
echo "清理完成。"
...
# 重命名主执行文件以包含目标平台信息
mv \
 ./frontend/src-tauri/bin/BiliNoteBackend/BiliNoteBackend\
 ./frontend/src-tauri/bin/BiliNoteBackend/BiliNoteBackend-$TARGET_TRIPLE

echo "PyInstaller 打包完成。"
echo "打包后的目录内容："
ls -l ./frontend/src-tauri/bin/BiliNoteBackend
